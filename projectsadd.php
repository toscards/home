...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Add Project - Faculty Management System</title>
...
<body>
   ...
   <h2>Add Student's Project Details</h2><br>
 <div class="col-lg-12"> 
		   
		   <div class="well bs-component">
  <form class="form-horizontal" onsubmit="return verify1();" id="infoForm1" method="POST" >
  <fieldset>
    <legend>You can Add New Project of Student from this page.</legend>
...
<?    $i= $i+1; }  }else{ echo "No Streams added to Display"; } mysqli_close($conn); ?>
	...
	<div class="form-group">
      ...
      <div class="col-lg-10">
        <input class="form-control" id="inputPassword" placeholder="Enter Project's Title" type="text" name="projecttitle" maxlength="100" required>
         </div>
    </div>
	...
	<div class="form-group">
	  ...
	  <input type="hidden" value="addproject" name="formtype"/>
