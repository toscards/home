...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Add Class - Faculty Management System</title>
  ...
  <fieldset>
    <legend>You can Add New Class from this page.</legend>
    <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Class Initials</label>
      <div class="col-lg-10"> 
        <input class="form-control" id="inputPassword" placeholder="Enter Class initials. Eg. FY-BCOM"  type="text" name="classinitials" maxlength="50"  required>
         </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-lg-10">
        <input class="form-control" id="inputPassword" placeholder="Enter Full Class Name" type="text" name="classfullname" maxlength="100" required>
         </div>
    </div>
    <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Class Strength</label>
      <div class="col-lg-10">
        <input class="form-control" id="inputPassword" placeholder="Enter Class Strength in Numeric" pattern="^\d{1,3}$" oninvalid="setCustomValidity('Please enter valid Number')" onchange="try{setCustomValidity('')}catch(e){}"  type="text" name="classstrength" maxlength="3" required>
         </div>
    </div>
	<div class="form-group">
...
<?    $i= $i+1; }  }else{ echo "No Streams added to Display"; } mysqli_close($conn); ?>
    ...
    <div class="form-group">
	  ...
	  <input type="hidden" value="classadd" name="formtype"/>
