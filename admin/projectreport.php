...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>View Project Report - Faculty Management System</title>
...
<?    $i= $i+1; }  }else{ echo "No Streams added to Display"; } mysqli_close($conn); ?>
	...
	<div class="form-group">
	  ...
	  <input type="hidden" value="showprojectsreport" name="formtype"/>
        <button type="submit" class="btn btn-primary">Show Project Reports</button>
...
<br><br><div id="show1" style="font-weight:bold;"></div>
