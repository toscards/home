...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Add Department - Faculty Management System</title>
  ...
  <fieldset>
    <legend>You can Add New Department from this page.</legend>
    <div class="form-group">
      <label for="inputPassword" class="col-lg-2 control-label">Dept. Initials</label>
      <div class="col-lg-10"> 
        <input class="form-control" id="inputPassword" placeholder="Enter Department initials. Eg. BCOM"  type="text" name="deptinitials" maxlength="50"  required>
         </div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-lg-10">
        <input class="form-control" id="inputPassword" placeholder="Enter Full Department Name" type="text" name="deptfullname" maxlength="100" required>
         </div>
    </div>
    ...
    <div class="form-group">
	  ...
	  <input type="hidden" value="departmentadd" name="formtype"/>
