...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>View Student Results - Faculty Management System</title>
...
<?    $i= $i+1; }  }else{ echo "No Streams added to Display"; } mysqli_close($conn); ?>
	...
	<div class="form-group">
	  ...
	  <input type="hidden" value="showresults" name="formtype"/>
        <button type="submit" class="btn btn-primary">Show Student Results</button>
