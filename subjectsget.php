...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Get Subject Details - Faculty Management System</title>
...
<?    $i= $i+1; }  }else{ echo "No Streams added to Display"; } mysqli_close($conn); ?>
	...
	<div class="form-group">
	  ...
	  <input type="hidden" value="showsubjects" name="formtype"/>
        <button type="submit" class="btn btn-primary">Show Subject</button>
